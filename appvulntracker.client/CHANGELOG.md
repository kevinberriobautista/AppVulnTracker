...
- Create Angular project with ng: `ng new appvulntracker.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`appvulntracker.client.esproj`).
